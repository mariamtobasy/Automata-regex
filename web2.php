...
<head>
    ...
    <style>
        ...
        form{ position: absolute;  z-index: 4;  margin: auto;
                width: 10%;
                padding: 10px;}
        ...
        .text{ position: absolute;  z-index: 5; justify-content: center;
                     align-items: center;}
</style>
...
<body >
    ...
    <div class="cont">
       <div class="package">
            ...
            <div class="text"><p class="name"><label for="name">
  <?php
...
function IPPatterns($ip) {
    $ipv4Pattern = '/\b((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9]?[0-9])\.){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9]?[0-9])\b/';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<h4 color='white'>$ipCheck</h4>" ;
    ...
    elseif ($ipCheck === "IPv6 address detected.") 
    echo "\n";
    else {
